...
from seed.utils.outputs import TokenPairOutput


@dataclass
class TokenPairModelArguments:
    """
...
class RobertaForTokenPairClassification(RobertaPreTrainedModel):
    _keys_to_ignore_on_load_unexpected = [r"pooler"]
