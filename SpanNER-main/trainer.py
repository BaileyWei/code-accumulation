...
class BertNerTagger(pl.LightningModule):
    ...
    def __init__(
        ...
        self.roberta_dir = args.roberta_config_dir
        ...
        roberta_config = RobertaNerConfig.from_pretrained(
    ...
    def get_parser():
        ...
        #                     default="/data/workspace/weiyubai/SpanNER-main/model", help='default_root_dir')
        parser.add_argument("--data_dir", type=str, default="./data/us_data", help="data dir")
        parser.add_argument("--bert_config_dir", type=str, default="bert-base-cased",  help="bert config dir")
        parser.add_argument("--roberta_config_dir", type=str, default="roberta-base",  help="roberta config dir")
        ...
        parser.add_argument("--dataname", default="us_data", help="the name of a dataset")
        parser.add_argument("--max_spanLen", type=int, default=20, help="max span length")
        # parser.add_argument("--margin", type=float, default=0.03, help="margin of the ranking loss")
        parser.add_argument("--n_class", type=int, default=9, help="the classes of a task")
    ...
    def test_epoch_end(
        ...
        all_predicts = [list(x['predicts'].cuda()) for x in outputs]
    ...
    def get_dataloader(self, prefix="train", limit: int = None) -> DataLoader:
        ...
        load_mmap_dataset
        """
        json_path = os.path.join(self.data_dir, f"us_{prefix}.json")
        ...
        # vocab_path = os.path.join(self.bert_dir, "vocab.json")
        vocab_path = os.path.join('/data/workspace/weiyubai/SpanNER-main/roberta/', "vocab.json")
...
def main():
    ...
    elif args.dataname == 'us_data':
        label2idx = {'O': 0, 'subsection': 1, 'subparagraph': 2, 'clause': 3, 'paragraph': 4, 'subdivision': 5, 'division': 6, 'section':7, 'designator':8}
    label2idx_list = []
    ...
    args.default_root_dir = r'/data/workspace/weiyubai/SpanNER-main/model'
